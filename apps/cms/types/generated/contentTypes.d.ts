...
export interface ApiAiModelAiModel extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Reference page for an AI model';
  ...
  attributes: {
    contextWindow: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.RichText;
    docsUrl: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    modalities: Schema.Attribute.JSON;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    pricingSummary: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiAiToolAiTool extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A curated AI tool listing';
    displayName: 'AI Tool';
    pluralName: 'ai-tools';
  ...
  attributes: {
    ...
    freeTierAvailable: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    pricingDefaultTab: Schema.Attribute.String;
    pricingModel: Schema.Attribute.Enumeration<
      ['free', 'freemium', 'paid', 'enterprise']
    > &
      Schema.Attribute.Required;
    pricingNotes: Schema.Attribute.Text;
    pricingSummary: Schema.Attribute.Text;
    pricingTabs: Schema.Attribute.JSON;
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Long-form AI article';
    displayName: 'Article';
    pluralName: 'articles';
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Shared taxonomy for JelajahAI content';
...
export interface ApiNewsletterNewsletter extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Newsletter subscription capture';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['pending', 'confirmed']> &
      Schema.Attribute.Required &
...
export interface ApiPromptPrompt extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    recommendedModels: Schema.Attribute.Relation<
      'manyToMany',
      'api::ai-model.ai-model'
    >;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    useCaseDescription: Schema.Attribute.Text & Schema.Attribute.Required;
  };
}
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  collectionName: 'tags';
  info: {
    description: 'Shared topic label for JelajahAI content';
    displayName: 'Tag';
    pluralName: 'tags';
    singularName: 'tag';
  };
...
export interface ApiTutorialTutorial extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Step-based tutorial content';
